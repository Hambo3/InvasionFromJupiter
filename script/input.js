...
class Input extends GamePad{
    static Up(){return this.IsDown('ArrowUp') || this.IsDown('KeyW') ||this.Btn(12) || this.Joy(1,-1)}
    static Down(){return this.IsDown('ArrowDown') || this.IsDown('KeyS') || this.Btn(13) || this.Joy(1,1)}
    ...
    static Fire1(){return this.IsSingle('KeyC') || this.Btn(2)}
    static Fire2(){return this.IsSingle('KeyV') || this.Btn(2)}
}
